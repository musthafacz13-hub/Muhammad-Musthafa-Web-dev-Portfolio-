...
import { MapPin, Code, Laptop } from 'lucide-react';
    ...
    <section id="about" className="py-20 sm:py-28 px-6 sm:px-12 max-w-5xl mx-auto relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
        ...
        <motion.div
          ...
          className="md:col-span-8 glass-card p-8 sm:p-10 rounded-3xl flex flex-col justify-between"
        >
          <div className="space-y-4 text-base sm:text-lg text-[#1d1d1f]/90 leading-relaxed">
            <p>
            ...
            <p className="text-[#86868b] text-base">
              I focus on clear visual hierarchy, accessible interactions, and practical code structures.
            </p>
          </div>

          <div className="mt-8 pt-6 border-t border-black/5 flex items-center gap-3 text-xs text-[#86868b]">
        ...
        >
          <div className="glass-card p-6 rounded-3xl flex-1 flex flex-col justify-center">
            ...
            <h3 className="text-sm font-semibold text-[#1d1d1f]">Design</h3>
          ...
          <div className="glass-card p-6 rounded-3xl flex-1 flex flex-col justify-center">
            ...
            <h3 className="text-sm font-semibold text-[#1d1d1f]">Development</h3>
            <p className="text-xs text-[#86868b] mt-1">
