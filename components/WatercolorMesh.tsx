...
export function WatercolorMesh() {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden select-none">
      ...
      <div 
        className="absolute inset-0 z-0 opacity-60 dark:opacity-20 transition-opacity duration-300"
        style={{
          background: `
      ...
      <div 
        className="absolute -top-[10%] -left-[10%] w-[50vw] h-[50vw] max-w-[700px] max-h-[700px] rounded-full bg-blue-200/30 dark:bg-blue-900/20 blur-[120px] animate-mesh-1" 
      />
      
      <div 
        className="absolute top-[20%] -right-[10%] w-[55vw] h-[55vw] max-w-[800px] max-h-[800px] rounded-full bg-purple-200/25 dark:bg-purple-900/20 blur-[130px] animate-mesh-2" 
      />
